...
| Martha Elizabeth Castorena Rivera | Despliegue, GitHub Actions y evidencia | Media | `docker-compose.test.yml`, `.github/workflows/tests.yml`, logs y evidencia de ejecución |
